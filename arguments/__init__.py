...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.mlp_feat_lr_init = 0.002
        self.mlp_feat_lr_final = 0.0002
        self.mlp_feat_lr_delay_mult = 0.01
        self.mlp_feat_lr_max_steps = 30_000
