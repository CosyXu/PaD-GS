...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=None):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["OpenMVG"](args.source_path, args.white_background, args.eval, args.dataset_type, args.crop_image)
        else:
        ...
        for resolution_scale in resolution_scales:
            ...
            print(len(self.test_cameras[resolution_scale]))
